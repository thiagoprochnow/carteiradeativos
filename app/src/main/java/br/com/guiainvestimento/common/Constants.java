...
public final class Constants {
    ...
    // Flag field to know if a investment was updated automatticaly or not
    // If not, will show option to update manually prices
