...
public class AddStockDialogFragment extends BaseDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setNegativeButton(R.string.cancel_stock_button, new DialogInterface
                .OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener
            ...
            public void onClick(View v) {
                ...
                // If validations are ok, dialog will be dismissed and stock added, otherwise
                // error will be shown to correct input fields.
