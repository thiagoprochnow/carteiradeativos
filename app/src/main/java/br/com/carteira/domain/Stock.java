...
public class Stock implements Serializable{
    ...
    // (Compra) Total paid for buying the current owned Stock. The same as stocksQuantity*boughtValue. (EX:R$3245,00)
    ...
    // [Set by user] The objective percentual value that the user wants to have of this stock compared to his whole stock portfolio
    // If the user has a total of R$10.000 of stocks and sets his objective as 10% for PETR4, and after a high gain value of the stock, he now has R$1500,00 on PETR4
