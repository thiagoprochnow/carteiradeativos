...
public class AddFiiDialogFragment extends BaseDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.show();
        // Implement the positive button here. If it is all correct, the Dialog will be dismissed and the fii added.
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                // If validations are ok, dialog will be dismissed and fii added, otherwise error will be shown to correct input fields.
